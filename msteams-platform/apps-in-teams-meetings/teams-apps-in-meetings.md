...
✔ Une application est visible dans une réunion Teams dans le panneau latéral ou dans la boîte de dialogue de la réunion. Utilisez la boîte de dialogue de réunion pour présenter du contenu actionnable aux participants à la réunion. *Voir* [Créer des applications pour les réunions Teams.](create-apps-for-teams-meetings.md)
