...
✔ types d’utilisateurs dans une réunion, par exemple dans un client, invité, fédéré ou anonyme Teams utilisateur.
...
Les onglets permettent aux membres de l’équipe d’accéder aux services et au contenu dans un espace spécifique au sein d’un canal ou d’une conversation. Cela permet à l’équipe de travailler directement avec des onglets et d’avoir des conversations sur les outils et les données disponibles dans les onglets. Dans Teams réunion, les utilisateurs peuvent ajouter un onglet en sélectionnant plus <img src="~/assets/images/apps-in-meetings/plusbutton.png" alt="Plus button" width="30"/>, et en choisissant l’application qu’ils souhaitent installer en tant qu’onglet.

> [!IMPORTANT]
> Si vous avez intégré un onglet à votre réunion, votre [](../tabs/how-to/authentication/auth-aad-sso.md) application doit suivre le flux d’authentification unique Teams pour les onglets.
...
✔ utilisateurs autorisés sont des utilisateurs qui peuvent ajouter des applications à une réunion pendant différentes étapes du cycle de vie de la réunion. Ces utilisateurs peuvent ajouter des applications à une réunion via la galerie d’onglets de deux manières :
   ...
   * À **l’aide de l’onglet Détails** du Teams de planification.
...
✔ disposition des onglets doit être organisée s’il existe plusieurs (plus de dix) sondages ou enquêtes.
...
✔ une application est visible dans une Teams dans le panneau latéral ou dans la boîte de dialogue de la réunion. Utilisez la boîte de dialogue de réunion pour présenter le contenu actionnable aux participants à la réunion. Pour plus d’informations, voir [créer des applications pour Teams réunions.](create-apps-for-teams-meetings.md)

   > [!NOTE]
   > Le manifeste de votre application spécifie que votre onglet est [optimisé](create-apps-for-teams-meetings.md#during-a-meeting)pour le panneau latéral, c’est-à-dire l’endroit où il est affiché. Il peut également faire partie d’une expérience de partage de bacs, sous réserve des instructions de conception spécifiées.
...
✔ disposition des onglets doit être organisée lorsqu’il y a plus de dix sondages ou enquêtes.

### <a name="integrate-bots-into-the-meeting-lifecycle"></a>Intégrer des bots dans le cycle de vie de la réunion

Pour l’implémentation du bot, commencez [par créer un bot,](../build-your-first-app/build-bot.md) puis continuez à créer des applications [pour Teams réunions.](../apps-in-teams-meetings/create-apps-for-teams-meetings.md#meeting-apps-api-reference)
...
Pour l’implémentation de l’extension de messagerie, commencez par créer une [extension](../messaging-extensions/how-to/create-messaging-extension.md) de messagerie, puis continuez avec la création d’applications [pour Teams réunions.](../apps-in-teams-meetings/create-apps-for-teams-meetings.md#meeting-apps-api-reference)
...
* In Teams, go to **Calendar** ![ calendar ](../assets/images/apps-in-meetings/calendar-logo.png) logo, select a meeting, and then **Meeting options**.
