...
Pour partager l’intégralité de l’application à l’étape, dans le manifeste de l’application, vous devez configurer et en tant que `meetingStage` `meetingSidePanel` contextes de trame. Par exemple :
