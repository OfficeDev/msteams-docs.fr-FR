...
|Autorisation d’application| Opération |
| ----- | ----- |
...
> [!NOTE]
> Les autorisations spécifiques aux ressources sont disponibles uniquement pour Teams applications installées sur le client Teams et ne font actuellement pas partie du portail Azure Active Director.

## <a name="enable-rsc-in-your-application"></a>Activer RSC dans votre application

1. [Configurez les paramètres de consentement dans le portail Azure AD.](#configure-consent-settings-in-the-azure-ad-portal)
...
1. [Enregistrez votre application auprès Plateforme d'identités Microsoft à l’aide Azure AD portail.](#register-your-app-with-microsoft-identity-platform-using-the-azure-ad-portal)
1. [Examinez vos autorisations d’application dans Azure AD portail.](#review-your-application-permissions-in-the-azure-ad-portal)
...
|---|---|---|
|`id` |Chaîne |Votre ID Azure AD’application. Pour plus d’informations, [voir inscrire votre application dans le portail Azure AD.](resource-specific-consent.md#register-your-app-with-microsoft-identity-platform-using-the-azure-ad-portal)|
