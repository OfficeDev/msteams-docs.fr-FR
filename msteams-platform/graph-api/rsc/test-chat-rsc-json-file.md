...
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="aab9d-104">Test de la collection Postman RSC de conversation pour JSON</span><span class="sxs-lookup"><span data-stu-id="aab9d-104">Test chat RSC Postman collection for JSON</span></span>
