...
author: surbhigupta
description: Dans ce module, découvrez les commandes de recherche d’extension de message pour Teams applications, pour créer une commande de recherche via le manifeste d’application et manuellement.
ms.topic: conceptual
ms.author: anclear
