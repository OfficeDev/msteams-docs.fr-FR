...
Enregistrez l’ID de votre application bot et votre mot de passe d’application. Vous devez fournir l’ID de l’application dans le manifeste de votre application.
