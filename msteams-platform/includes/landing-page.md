...
ms.locfileid: "44173630"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Plateforme pour les développeurs de Microsoft Teams</h1>
        <ul class="pivots">
            <li>
                ...
                <ul id="get-started" class="cardsF panelContent singlePanelContent" style="display:flex!important;">
                    <li>
                        <div class="container intro" style="margin-top:-20px;">
                            <h2>Prise en main de la création d’applications sur la plateforme Microsoft Teams</h2>
                        </div>
                    </li>
                    <li>
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">Explorer la documentation</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                              href="/microsoftteams/platform/overview">Création d’applications sur la plateforme Microsoft Teams</a></p>
                                        <p ><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/tabs/what-are-tabs"><img src="/microsoftteams/platform/assets/icons/tab-icon-2.svg" height="16" width="16" alt="tab icon">Onglets : expériences web incorporées</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/bots/what-are-bots"><img src="/microsoftteams/platform/assets/icons/bot-icon-2.svg" height="16" width="16"  alt="bot icon">Bots : interactions basées sur des conversations</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/messaging-extensions/what-are-messaging-extensions"><img src="/microsoftteams/platform/assets/icons/messaging-icon-2.svg" height="16" width="16" alt="messaging icon">Extensions de messagerie : interactions orientées tâche</a></p>
                                         <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/task-modules-and-cards/what-are-task-modules"><img src="https://docs.microsoft.com/media/common/i_queries.svg" height="16" width="16" alt="task module icon">Modules de tâche et cartes : messagerie et notifications enrichies</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/webhooks-and-connectors/what-are-webhooks-and-connectors"><img src="https://docs.microsoft.com/media/common/i_service-hooks.svg" height="16" width="16" alt="webhooks connectors icon">Webhooks et connecteurs : messagerie programmée et notifications</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                        ...
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://docs.microsoft.com/microsoftteams/"><img src="https://docs.microsoft.com/media/common/i_identity-protection.svg" height="16" width="16" alt="teams admin icon">Administration Microsoft Teams</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">Créer votre première application</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/tutorials/get-started-nodejs-app-studio">Prise en main de Node.js</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="/microsoftteams/platform/tutorials/get-started-dotnet-app-studio">Prise en main de .NET/C#</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">Connectez-vous à notre communauté</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://developer.microsoft.com/microsoft-teams/blogs/">Blog pour les développeurs de Microsoft Teams</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://aka.ms/microsoftteamscommunitycall">Appel de communauté Microsoft Teams</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                            href="/microsoftteams/platform/feedback">Commentaires et support</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cardSize">
                            <div class="cardPadding">
                                <div class="card">
                                    ...
                                    <div class="cardText">
                                        <h3 style="font-size: 1.15rem">Formation et apprentissage guidés</h3>
                                        <hr />
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://docs.microsoft.com/learn/modules/intro-microsoft-teams-apps/">Introduction à la création d’applications pour Teams</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                                href="https://docs.microsoft.com/learn/modules/embedded-web-experiences/">Créer des expériences web incorporées avec les onglets</a></p>
                                        <p><a class="barLink" style="font-size: 0.95rem"
                                            href="https://www.youtube.com/c/MicrosoftTeamsPlatform">Vidéos de formation sur les développeurs d’applications (sur YouTube)</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <li>
                <a href="#samples-demos-templates">Modèles, intégrations &amp; exemples</a>
                <ul id="samples-demos-templates">
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Application Réponses rapides</h3>
                                                    <p>Répondez efficacement aux questions fréquemment posées par les utilisateurs et créez une bibliothèque dynamique de réponses.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Robot d’assistance à distance</h3>
                                                    <p>Fournit une interface prioritaire entre les demandeurs au sein de votre organisation et de l’équipe de support interne.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bot Rapport d’incident</h3>
                                                    <p>Optimisez la gestion des incidents au sein de votre organisation.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Application Demander une équipe</h3>
                                                    <p>Améliorez le flux de création d’équipe de votre organisation.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <ul id="samples" class="cardsI panelContent">
                            <li>
                                <div class="container intro" style="margin-top:-20px;">
                                    <h2>Applications simples montrant les fonctionnalités de la plateforme</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Hello World</h3>
                                                <p>Application simple avec onglet et bot.</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-samples-hello-world-csharp">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Bot de conversation Teams</h3>
                                                <p>Bot qui illustre les événements de conversation types</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/57.teams-conversation-bot">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/javascript_nodejs/57.teams-conversation-bot">Version JavaScript/Node.js</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Extensions de messagerie : commande action</h3>
                                                <p>Une extensions de messagerie avec une commande action</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/51.teams-messaging-extensions-action">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Extensions de messagerie : commande de recherche</h3>
                                                <p>Une extensions de messagerie avec une commande de recherche</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/microsoft/BotBuilder-Samples/tree/master/samples/csharp_dotnetcore/52.teams-messaging-extensions-search-auth-config">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Connecteur Office 365</h3>
                                                <p>Application MVC utilisant un connecteur pour pousser des cartes vers Microsoft Teams</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-connector-csharp">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Illustre les modèles permettant de gérer différents scénarios d’authentification.</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-auth-node">Version Node.js</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Graph + Teams</h3>
                                                <p>Combiner Microsoft Teams et Graph</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/microsoftgraph/csharp-teams-sample-graph/tree/master/source">Version C#/.NET</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/microsoftgraph/csharp-teams-sample-graph/tree/master/Node">Version Node.js</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Webhook sortant</h3>
                                                <p>Application MVC pouvant retourner des exemples de cartes à un webhook sortant</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                        href="https://github.com/OfficeDev/microsoft-teams-sample-outgoing-webhook">Version C#/.NET</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <li>
                        <a href="#demos">Applications de démonstration</a>
                        <ul id="demos" class="cardsI panelContent">
                            <li>
                                <div class="container intro" style="margin-top:-20px;">
                                    <h2>Applications complexes présentant plusieurs fonctionnalités</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>L’application tout</h3>
                                                <p>Une application complexe présentant quasiment toutes les fonctionnalités de l’application Teams disponibles</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-complete-node">Version Node.js</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-complete-csharp">Version C#/.NET</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Communications d’entreprise</h3>
                                                <p>Exemples de communications organisationnelles et de notifications</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/CompanyCommunicator">Communicateur d’entreprise</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/NotificationBot">Bot de Notifications</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Scénario de compagnie aérienne</h3>
                                                <p>Une collection de cinq bots .NET/C# complexes présentant les activités quotidiennes de la compagnie aérienne</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FleetInfoBot">Bot d'informations sur la flotte</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FlightInfo">Bot d'informations sur le vol</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/BaggageInfo">Bot d'informations sur les voyages</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/FlightTeamCreation">Création d’une équipe de vol</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Airline/PassengerInfo">Bot d'informations sur les passagers</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Ligne générale de l’entreprise</h3>
                                                <p>Applications présentant les fonctionnalités de plateforme pour résoudre les problèmes professionnels </p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/microsoft-teams-sample-todo">Application ToDo</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Cross%20Vertical/PollingBot">Bot de sondage</a></p>
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Manufacturing">Gestion des stocks</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Demande et approbation des congés des employés</p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-line-of-business-apps-csharp/tree/master/Professional%20Services">Application congé pour employé</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>Gérer Teams à partir d’une application Teams </p>
                                                <hr />
                                                <p><a class="barLink" style="font-size: 0.95rem" 
                                                    href="https://github.com/OfficeDev/msteams-sample-adminbot-csharp">Bot d’administration Teams</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <li>
                <a href="#sdk-tools">SDKs &amp; Outils</a>
                <ul id="sdk-tools">
                    <li>
                        ...
                        <ul id="sdk-tools-all" class="cardsF">
                            <li class="fullSpan">
                                <div class="container" style="margin-top:-20px">
                                    <h2>Kits de développement logiciel (SDK)</h2>
                                </div>
                            </li>
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Kit de développement logiciel JavaScript pour les onglets</h3>
                                                <p>
                                                    <a
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Kits de développement logiciel (SDK) Bot Framework Nœud. js pour les bots et extensions de messagerie</h3>
                                                <p>
                                                    <a href="https://github.com/Microsoft/BotBuilder-Samples">Exemples</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Kits de développement logiciel (SDK) Bot Framework .NET pour les bots et extensions de messagerie</h3>
                                                <p>
                                                    <a href="https://github.com/Microsoft/BotBuilder-Samples">Exemples</a>
                                                </p>
                                                <p>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Kits de développement logiciel (SDK) Microsoft Graph</h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/graph/sdks/sdks-overview">Présentation des graphiques SDK</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/graph/sdks/sdk-installation">Installer les graphiques SDKs</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                ...
                                                <p>
                                                    <a href="https://aka.ms/InstallTeamsAppStudio">Installer App Studio dans Teams</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Générateur Yeoman pour Microsoft Teams</h3>
                                                <p>
