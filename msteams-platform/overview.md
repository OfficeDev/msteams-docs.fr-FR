...
## <a name="test-your-app-running-across-microsoft-365"></a>Testez votre application en cours d’exécution Microsoft 365

Vous pouvez prévisualiser vos applications Teams en cours d’exécution dans d’autres expériences Microsoft 365 d’utilisation élevée avec Microsoft Teams client JavaScript SDK v2 Preview.
