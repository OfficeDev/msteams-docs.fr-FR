...
Une fois le référentiel cloné, exécutez la commande de modification du répertoire dans le terminal pour changer le répertoire en exemple :
...
Notez l’URL de votre application. Vous en aurez besoin ultérieurement lorsque vous enregistrerez l’application auprès de Teams à l’aide d’App studio ou du portail du développeur.
...
Sélectionnez l’un des textes aléatoires et vous verrez une carte mise en forme et prête à être envoyé avec votre propre message en bas :
