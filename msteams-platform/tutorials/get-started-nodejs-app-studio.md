...
---
# <a name="create-your-first-microsoft-teams-app-using-nodejs"></a>Créez votre première application Microsoft Teams l’aide Node.js

Ce didacticiel vous aide à commencer à créer une application Microsoft Teams l’aide Node.js.
...
> [!NOTE]
> Utilisez la fenêtre terminal la plus à l’aise sur votre plateforme. Ces exemples utilisent Bash (qui est inclus dans Git), mais ces scripts s’exécuteront sur la plupart des plateformes.
