...
description: Découvrez comment optimiser le bot avec une limitation de débit. Détecter les exceptions temporaires, par limite de thread de bot. Vous pouvez également effectuer un backoff exponentiel.
