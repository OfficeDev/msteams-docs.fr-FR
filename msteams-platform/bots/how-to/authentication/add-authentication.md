...
1. Vous devez ensuite vous rediriger vers une page **De connexion test à \<your-connection-name> Réussite.** Actualisez la page si vous obtenez une erreur. L’image suivante est un exemple :
