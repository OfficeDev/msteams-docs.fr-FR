...
- <span data-ttu-id="c4c43-127">L’exemple suivant.</span><span class="sxs-lookup"><span data-stu-id="c4c43-127">The following sample.</span></span>
    ...
    | <span data-ttu-id="c4c43-128">Échantillon</span><span class="sxs-lookup"><span data-stu-id="c4c43-128">Sample</span></span> | <span data-ttu-id="c4c43-129">Version d’BotBuilder</span><span class="sxs-lookup"><span data-stu-id="c4c43-129">BotBuilder version</span></span> | <span data-ttu-id="c4c43-130">Montre</span><span class="sxs-lookup"><span data-stu-id="c4c43-130">Demonstrates</span></span> |
    |:---|:---:|:---|
...
<span data-ttu-id="c4c43-195">Pour plus d’informations, consultez [la rubrique Create a bot for teams](../create-a-bot-for-teams.md).</span><span class="sxs-lookup"><span data-stu-id="c4c43-195">For more information, see [Create a bot for Teams](../create-a-bot-for-teams.md).</span></span>
...
1. <span data-ttu-id="c4c43-238">Remplissez le formulaire comme suit :</span><span class="sxs-lookup"><span data-stu-id="c4c43-238">Complete the form as follows:</span></span>
    ...
    1. <span data-ttu-id="c4c43-249">**Type d’autorisation**.</span><span class="sxs-lookup"><span data-stu-id="c4c43-249">**Grant Type**.</span></span> <span data-ttu-id="c4c43-250">Entrée `authorization_code` .</span><span class="sxs-lookup"><span data-stu-id="c4c43-250">Enter `authorization_code`.</span></span>
...
1. <span data-ttu-id="c4c43-266">Sélectionnez **Enregistrer**.</span><span class="sxs-lookup"><span data-stu-id="c4c43-266">Select **Save**.</span></span>
...
1. <span data-ttu-id="c4c43-348">Dans la fenêtre de boîte de dialogue suivante, entrez les informations requises.</span><span class="sxs-lookup"><span data-stu-id="c4c43-348">In the next dialog window, enter the required information.</span></span> <span data-ttu-id="c4c43-349">Voici un exemple :</span><span class="sxs-lookup"><span data-stu-id="c4c43-349">The following is an example:</span></span>
...
### <a name="test-the-bot-locally"></a><span data-ttu-id="c4c43-382">Tester le bot localement</span><span class="sxs-lookup"><span data-stu-id="c4c43-382">Test the bot locally</span></span>
...
1. <span data-ttu-id="c4c43-398">En fonction de la configuration que vous avez utilisée pour l’émulateur, vous obtenez l’un des éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="c4c43-398">Depending which configuration you used for the Emulator, you get one of the following:</span></span>
    ...
    <span data-ttu-id="c4c43-404">L’image suivante est un exemple de l’interface utilisateur du bot une fois que vous avez ouvert une session :</span><span class="sxs-lookup"><span data-stu-id="c4c43-404">The following image is an example of the bot UI after you've logged in:</span></span>
...
1. <span data-ttu-id="c4c43-423">Si vous y êtes invité, sélectionnez le compte de l’utilisateur concerné.</span><span class="sxs-lookup"><span data-stu-id="c4c43-423">If asked, select the applicable user's account.</span></span>
    ...
    ![connexion à un bot auth déployée](../../../assets/images/authentication/auth-bot-login-deployed.PNG)<span data-ttu-id="c4c43-426">.</span><span class="sxs-lookup"><span data-stu-id="c4c43-426">.</span></span>
...
<span data-ttu-id="c4c43-447">L’Assistant suivant s’affiche :</span><span class="sxs-lookup"><span data-stu-id="c4c43-447">The following wizard is displayed:</span></span>
...
1. <span data-ttu-id="c4c43-472">Ajouter `/api/messages` pour obtenir `https://dea822bf.ngrok.io/api/messages` .</span><span class="sxs-lookup"><span data-stu-id="c4c43-472">Append `/api/messages` to obtain `https://dea822bf.ngrok.io/api/messages`.</span></span> <span data-ttu-id="c4c43-473">Il s’agit du **point de terminaison de messages** pour le robot s’exécutant localement sur votre ordinateur et accessible via le Web dans une conversation dans Microsoft Teams.</span><span class="sxs-lookup"><span data-stu-id="c4c43-473">This is the **messages endpoint** for the bot running locally on your machine and reachable over the web in a chat in Microsoft Teams.</span></span>
1. <span data-ttu-id="c4c43-474">Une dernière étape consiste à mettre à jour le point de terminaison des messages du bot déployé.</span><span class="sxs-lookup"><span data-stu-id="c4c43-474">One final step to perform is to update the messages endpoint of the deployed bot.</span></span> <span data-ttu-id="c4c43-475">Dans l’exemple, nous avons déployé le bot dans Azure.</span><span class="sxs-lookup"><span data-stu-id="c4c43-475">In the example, we deployed the bot in Azure.</span></span> <span data-ttu-id="c4c43-476">So \* \* nous allons effectuer les étapes suivantes :</span><span class="sxs-lookup"><span data-stu-id="c4c43-476">So \*\*let's perform these steps:</span></span>
    1. <span data-ttu-id="c4c43-477">Dans votre navigateur, accédez au [**portail Azure**][azure-portal].</span><span class="sxs-lookup"><span data-stu-id="c4c43-477">In your browser navigate to the [**Azure portal**][azure-portal].</span></span>
    1. <span data-ttu-id="c4c43-478">Sélectionnez l' **enregistrement** de votre canal de robot.</span><span class="sxs-lookup"><span data-stu-id="c4c43-478">Select your **Bot Channel Registration**.</span></span>
    1. <span data-ttu-id="c4c43-479">Dans le volet de gauche, sélectionnez **paramètres**.</span><span class="sxs-lookup"><span data-stu-id="c4c43-479">In the left panel, select **Settings**.</span></span>
    1. <span data-ttu-id="c4c43-480">Dans le volet droit, dans la zone **point de terminaison de messagerie** , entrez l’URL ngrok, dans notre exemple, `https://dea822bf.ngrok.io/api/messages` .</span><span class="sxs-lookup"><span data-stu-id="c4c43-480">In the right panel, in the **Messaging endpoint** box, enter the ngrok URL, in our example, `https://dea822bf.ngrok.io/api/messages`.</span></span>
1. <span data-ttu-id="c4c43-481">Démarrez votre robot localement, par exemple en mode de débogage Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="c4c43-481">Start your bot locally, for example in Visual Studio debug mode.</span></span>
1. <span data-ttu-id="c4c43-482">Testez le robot tout en s’exécutant localement à l’aide de la **conversation Web test** du portail de l’infrastructure bot.</span><span class="sxs-lookup"><span data-stu-id="c4c43-482">Test the bot while running locally using the Bot Framework portal's **Test Web chat**.</span></span> <span data-ttu-id="c4c43-483">À l’instar de l’émulateur, ce test ne vous permet pas d’accéder aux fonctionnalités spécifiques des équipes.</span><span class="sxs-lookup"><span data-stu-id="c4c43-483">Like the Emulator, this test doesn't allow you to access Teams-specific functionality.</span></span>
1. <span data-ttu-id="c4c43-484">Dans la fenêtre de terminal où `ngrok` est exécuté, vous pouvez voir le trafic http entre le bot et le client de conversation Web.</span><span class="sxs-lookup"><span data-stu-id="c4c43-484">In the terminal window where `ngrok` is running you can see HTTP traffic between the bot and the web chat client.</span></span> <span data-ttu-id="c4c43-485">Si vous souhaitez une vue plus détaillée, dans une fenêtre de navigateur, entrez `http://127.0.0.1:4040` que vous avez obtenu à partir de la fenêtre de terminal précédente.</span><span class="sxs-lookup"><span data-stu-id="c4c43-485">If you want a more detailed view, in a browser window enter `http://127.0.0.1:4040` you obtained from the previous terminal window.</span></span> <span data-ttu-id="c4c43-486">L’image suivante est un exemple :</span><span class="sxs-lookup"><span data-stu-id="c4c43-486">The following image is an example:</span></span>

    ![tests ngrok des équipes de robots d’authentification](../../../assets/images/authentication/auth-bot-teams-ngrok-testing.png)<span data-ttu-id="c4c43-488">.</span><span class="sxs-lookup"><span data-stu-id="c4c43-488">.</span></span>

> [!NOTE]
> <span data-ttu-id="c4c43-489">Si vous arrêtez et redémarrez ngrok, l’URL change.</span><span class="sxs-lookup"><span data-stu-id="c4c43-489">If you stop and restart ngrok, the URL changes.</span></span> <span data-ttu-id="c4c43-490">Pour utiliser ngrok dans votre projet et selon les fonctionnalités que vous utilisez, vous devez mettre à jour toutes les références d’URL.</span><span class="sxs-lookup"><span data-stu-id="c4c43-490">To use ngrok in your project, and depending on the capabilities you're using, you must update all URL references.</span></span>
 

## <a name="additional-information"></a><span data-ttu-id="c4c43-491">Informations supplémentaires</span><span class="sxs-lookup"><span data-stu-id="c4c43-491">Additional information</span></span>

### <a name="teamsappmanifestmanifestjson"></a><span data-ttu-id="c4c43-492">TeamsAppManifest/manifest.jssur</span><span class="sxs-lookup"><span data-stu-id="c4c43-492">TeamsAppManifest/manifest.json</span></span>

<span data-ttu-id="c4c43-493">Ce manifeste contient les informations nécessaires à Microsoft teams pour se connecter au robot.</span><span class="sxs-lookup"><span data-stu-id="c4c43-493">This manifest contains information needed by Microsoft Teams to connect with the bot.</span></span>  
...
<span data-ttu-id="c4c43-494">Avec l’authentification, teams se comporte légèrement différemment des autres canaux, comme expliqué ci-dessous.</span><span class="sxs-lookup"><span data-stu-id="c4c43-494">With authentication, Teams behaves slightly differently than other channels, as explained below.</span></span>

### <a name="handling-invoke-activity"></a><span data-ttu-id="c4c43-495">Gestion de l’activité d’appel</span><span class="sxs-lookup"><span data-stu-id="c4c43-495">Handling Invoke Activity</span></span>

<span data-ttu-id="c4c43-496">Une **activité d’appel** est envoyée au bot au lieu de l’activité d’événement utilisée par d’autres canaux.</span><span class="sxs-lookup"><span data-stu-id="c4c43-496">An **Invoke Activity** is sent to the bot rather than the Event Activity used by other channels.</span></span>
<span data-ttu-id="c4c43-497">Cette opération est réalisée par la sous-classe du **ActivityHandler**.</span><span class="sxs-lookup"><span data-stu-id="c4c43-497">This is done by sub-classing the **ActivityHandler**.</span></span>

# <a name="cnet"></a>[<span data-ttu-id="c4c43-498">C#/.NET</span><span class="sxs-lookup"><span data-stu-id="c4c43-498">C#/.NET</span></span>](#tab/dotnet-sample)

<span data-ttu-id="c4c43-499">**Robots/DialogBot. cs**</span><span class="sxs-lookup"><span data-stu-id="c4c43-499">**Bots/DialogBot.cs**</span></span>

[!code-csharp[ActivityHandler](~/../botbuilder-samples/samples/csharp_dotnetcore/46.teams-auth/Bots/DialogBot.cs?range=19-51)]

<span data-ttu-id="c4c43-500">**Robots/TeamsBot. cs**</span><span class="sxs-lookup"><span data-stu-id="c4c43-500">**Bots/TeamsBot.cs**</span></span>

<span data-ttu-id="c4c43-501">L' *activité d’appel* doit être transférée à la boîte de dialogue si **OAuthPrompt** est utilisé.</span><span class="sxs-lookup"><span data-stu-id="c4c43-501">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-csharp[ActivityHandler](~/../botbuilder-samples/samples/csharp_dotnetcore/46.teams-auth/Bots/TeamsBot.cs?range=34-42)]

#### <a name="teamsactivityhandlercs"></a><span data-ttu-id="c4c43-502">TeamsActivityHandler.cs</span><span class="sxs-lookup"><span data-stu-id="c4c43-502">TeamsActivityHandler.cs</span></span>
...
# <a name="javascript"></a>[<span data-ttu-id="c4c43-503">JavaScript</span><span class="sxs-lookup"><span data-stu-id="c4c43-503">JavaScript</span></span>](#tab/node-js-dialog-sample)

<span data-ttu-id="c4c43-504">**robots/dialogBot.js**</span><span class="sxs-lookup"><span data-stu-id="c4c43-504">**bots/dialogBot.js**</span></span>

[!code-javascript[ActivityHandler](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/bots/dialogBot.js?range=4-46)]

<span data-ttu-id="c4c43-505">**robots/teamsBot.js**</span><span class="sxs-lookup"><span data-stu-id="c4c43-505">**bots/teamsBot.js**</span></span>

<span data-ttu-id="c4c43-506">L' *activité d’appel* doit être transférée à la boîte de dialogue si **OAuthPrompt** est utilisé.</span><span class="sxs-lookup"><span data-stu-id="c4c43-506">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-javascript[ActivityHandler](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/bots/teamsBot.js?range=4-33)]

<span data-ttu-id="c4c43-507">**boîtes de dialogue/mainDialog.js**</span><span class="sxs-lookup"><span data-stu-id="c4c43-507">**dialogs/mainDialog.js**</span></span>

<span data-ttu-id="c4c43-508">Dans une étape de dialogue, utilisez `beginDialog` pour démarrer l’invite OAuth, qui demande à l’utilisateur de se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-508">Within a dialog step, use `beginDialog` to start the OAuth prompt, which asks the user to sign in.</span></span>

- <span data-ttu-id="c4c43-509">Si l’utilisateur est déjà connecté, cela génère un événement de réponse au jeton, sans demander de confirmation à l’utilisateur.</span><span class="sxs-lookup"><span data-stu-id="c4c43-509">If the user is already signed in, this will generate a token response event, without prompting the user.</span></span>
- <span data-ttu-id="c4c43-510">Dans le cas contraire, l’utilisateur est invité à se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-510">Otherwise, this will prompt the user to sign in.</span></span> <span data-ttu-id="c4c43-511">Le service de robots Azure envoie l’événement de réponse de jeton une fois que l’utilisateur tente de se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-511">The Azure Bot Service sends the token response event after the user attempts to sign in.</span></span>

[!code-javascript[AddOAuthPrompt](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/mainDialog.js?range=50-52)]

<span data-ttu-id="c4c43-512">Dans l’étape suivante de la boîte de dialogue, vérifiez la présence d’un jeton dans le résultat de l’étape précédente.</span><span class="sxs-lookup"><span data-stu-id="c4c43-512">Within the following dialog step, check for the presence of a token in the result from the previous step.</span></span> <span data-ttu-id="c4c43-513">Si ce n’est pas le cas, l’utilisateur s’est connecté.</span><span class="sxs-lookup"><span data-stu-id="c4c43-513">If it is not null, the user successfully signed in.</span></span>

[!code-javascript[AddOAuthPrompt](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/mainDialog.js?range=50-64)]

<span data-ttu-id="c4c43-514">**robots/logoutDialog.js**</span><span class="sxs-lookup"><span data-stu-id="c4c43-514">**bots/logoutDialog.js**</span></span>

[!code-javascript[allow-logout](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/logoutDialog.js?range=31-42&highlight=7)]

# <a name="python"></a>[<span data-ttu-id="c4c43-515">Python</span><span class="sxs-lookup"><span data-stu-id="c4c43-515">Python</span></span>](#tab/python-sample)

<span data-ttu-id="c4c43-516">**bots/dialog_bot. py**</span><span class="sxs-lookup"><span data-stu-id="c4c43-516">**bots/dialog_bot.py**</span></span>

[!code-python[ActivityHandler](~/../botbuilder-samples/samples/python/46.teams-auth/bots/dialog_bot.py?range=10-42)]

<span data-ttu-id="c4c43-517">**bots/teams_bot. py**</span><span class="sxs-lookup"><span data-stu-id="c4c43-517">**bots/teams_bot.py**</span></span>

<span data-ttu-id="c4c43-518">L' *activité d’appel* doit être transférée à la boîte de dialogue si **OAuthPrompt** est utilisé.</span><span class="sxs-lookup"><span data-stu-id="c4c43-518">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-python[on_token_response_event](~/../botbuilder-samples/samples/python/46.teams-auth/bots/teams_bot.py?range=38-45)]

<span data-ttu-id="c4c43-519">**Dialogs/main_dialog. py**</span><span class="sxs-lookup"><span data-stu-id="c4c43-519">**dialogs/main_dialog.py**</span></span>

<span data-ttu-id="c4c43-520">Dans une étape de dialogue, utilisez `begin_dialog` pour démarrer l’invite OAuth, qui demande à l’utilisateur de se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-520">Within a dialog step, use `begin_dialog` to start the OAuth prompt, which asks the user to sign in.</span></span>

- <span data-ttu-id="c4c43-521">Si l’utilisateur est déjà connecté, cela génère un événement de réponse au jeton, sans demander de confirmation à l’utilisateur.</span><span class="sxs-lookup"><span data-stu-id="c4c43-521">If the user is already signed in, this will generate a token response event, without prompting the user.</span></span>
- <span data-ttu-id="c4c43-522">Dans le cas contraire, l’utilisateur est invité à se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-522">Otherwise, this will prompt the user to sign in.</span></span> <span data-ttu-id="c4c43-523">Le service de robots Azure envoie l’événement de réponse de jeton une fois que l’utilisateur tente de se connecter.</span><span class="sxs-lookup"><span data-stu-id="c4c43-523">The Azure Bot Service sends the token response event after the user attempts to sign in.</span></span>

[!code-python[Add OAuthPrompt](~/../botbuilder-samples/samples/python/46.teams-auth/dialogs/main_dialog.py?range=48-49)]

<span data-ttu-id="c4c43-524">Dans l’étape suivante de la boîte de dialogue, vérifiez la présence d’un jeton dans le résultat de l’étape précédente.</span><span class="sxs-lookup"><span data-stu-id="c4c43-524">Within the following dialog step, check for the presence of a token in the result from the previous step.</span></span> <span data-ttu-id="c4c43-525">Si ce n’est pas le cas, l’utilisateur s’est connecté.</span><span class="sxs-lookup"><span data-stu-id="c4c43-525">If it is not null, the user successfully signed in.</span></span>

[!code-python[Add OAuthPrompt](~/../botbuilder-samples/samples/python/46.teams-auth/dialogs/main_dialog.py?range=51-61)]

<span data-ttu-id="c4c43-526">**Dialogs/logout_dialog. py**</span><span class="sxs-lookup"><span data-stu-id="c4c43-526">**dialogs/logout_dialog.py**</span></span>
...
> [<span data-ttu-id="c4c43-527">En savoir plus sur l’ajout d’authentification via le service de robots Azure</span><span class="sxs-lookup"><span data-stu-id="c4c43-527">Learn about adding authentication via Azure Bot Service</span></span>](https://aka.ms/azure-bot-add-authentication)
