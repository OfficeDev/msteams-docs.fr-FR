...
En outre, la plateforme Real-time Media permet aux bots d'interagir avec les appels et réunions Teams à l'aide de la voix en temps réel, de la vidéo et du partage d'écran. Un bot qui participe à des appels audio ou vidéo et à des réunions en ligne est un bot Microsoft Teams ordinaire avec quelques fonctionnalités supplémentaires utilisées pour inscrire le bot.
