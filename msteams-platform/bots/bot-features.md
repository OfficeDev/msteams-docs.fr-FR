...
author: surbhigupta
description: Dans cet article, découvrez les outils et les kits SDK Bot Framework (C#, Python, Java, JavaScript) pour les bots Microsoft Teams, ainsi que ses avantages et inconvénients.
ms.topic: overview
...
* [Créer des déclencheurs personnalisés dans Bot Framework Composer](/composer/how-to-create-custom-triggers)
...
* [Informations de référence sur l’API pour le service Bot Framework Connector](/azure/bot-service/rest-api/bot-framework-rest-connector-api-reference)
