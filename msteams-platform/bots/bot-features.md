...
* Bot existant créé sur le SDK Microsoft Bot Framework.
* Power Virtual Agents service chatbot.
* Webhooks et connecteurs.

## <a name="bots-and-the-microsoft-bot-framework"></a>Bots et le Microsoft Bot Framework
...
* Votre Teams package d’application avec votre manifeste d’application. C’est ce que vos utilisateurs installent et connectent Teams client à votre service web, acheminé via le service bot.

[Bot Framework est](https://dev.botframework.com/) un SDK enrichi utilisé pour créer des bots à l’aide de C#, Java, Python et JavaScript. Si vous avez déjà un bot basé sur Bot Framework, vous pouvez facilement le modifier pour qu’il fonctionne Microsoft Teams. Utilisez les C# ou Node.js pour tirer parti de nos [SDK.](/microsoftteams/platform/#pivot=sdk-tools) Ces packages étendent les classes et méthodes de base du SDK Bot Builder comme suit :
...
> [!TIP]
> Teams App Studio vous aide à créer et configurer votre manifeste d’application, et à inscrire votre service web en tant que bot sur Bot Framework. Il contient également une bibliothèque React de contrôles et un générateur de cartes interactif. Pour plus d’informations, voir [la mise en Teams App Studio.](~/concepts/build-and-test/app-studio-overview.md)
