...
* **Bot** pour votre extension de messagerie automatiquement inscrite auprès du service Microsoft Azure Bot
...
Si vous avez installé votre application, mais qu'elle ne fonctionne pas, assurez-vous que le bot de l'extension de messagerie est connecté au canal Teams [ *azure* Bot Service.](https://docs.microsoft.com/azure/bot-service/channel-connect-teams?view=azure-bot-service-4.0&preserve-view=true)
