...
La prise en charge de la mise en forme diffère d’un type de carte à l’autre, et le rendu de la carte peut légèrement varier entre les clients de bureau et de Teams mobiles, ainsi que les Teams dans le navigateur de bureau.

Vous pouvez inclure une image inline avec n’importe Teams carte. Images au format , ou fichiers, qui ne doivent pas dépasser  `.png` `.jpg` `.gif` 1 024 × 1 024 px ou 1 Mo. L’image GIF animée n’est pas officiellement prise en charge. Pour plus d’informations, consultez la référence [des cartes.](./cards-reference.md#inline-card-images)
...
> * **Cartes de connecteur O365**: markdown et html limité sont pris en charge dans les cartes Office 365 connecteur dans les champs de texte.
...
Sur le bureau, la mise en forme Markdown de carte adaptative s’affiche comme ceci dans les navigateurs web et dans Teams application cliente :
...
[Fonctionnalités de texte dans les cartes adaptatives](/adaptive-cards/create/textfeatures) Les fonctionnalités de date et de localisation mentionnées dans cette rubrique ne sont pas Teams.
...
> [!NOTE]
> * [Les éléments multimédias](https://adaptivecards.io/explorer/Media.html) ne sont actuellement pas pris en charge dans les cartes adaptatives v1.2 sur Teams plateforme.
...
Ces captures d’écran ont été créées Teams AppStudio, où la propriété de texte d’une carte Hero a été définie sur la chaîne suivante. Vous pouvez tester la mise en forme dans vos propres cartes en modifiant ce code.
