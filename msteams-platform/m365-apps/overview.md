...
Pour obtenir des commentaires et des problèmes, veuillez continuer à utiliser les canaux de la communauté [Microsoft Teams développeurs appropriés.](/microsoftteams/platform/feedback) Nous attendons avec intérêt de vous en savoir plus !
...
En outre, avec cet aperçu, vous pouvez étendre vos extensions de messagerie Teams basées sur la recherche à Outlook sur le web et bureau Windows, ce qui permet aux clients de rechercher et de partager des résultats via la zone de composition de messages de Outlook, en plus des clients Microsoft Teams.
