...
---
# <a name="create-a-custom-channel-and-group-tab-with-nodejs-and-the-yeoman-generator-for-microsoft-teams"></a>Créer un canal et un onglet de groupe personnalisés avec Node.js et le générateur Yeoman pour Microsoft Teams
...
Dans ce démarrage rapide, nous allons créer un canal et un onglet de groupe personnalisés à l'aide du générateur [Yeoman Teams.](https://github.com/OfficeDev/generator-teams/)
