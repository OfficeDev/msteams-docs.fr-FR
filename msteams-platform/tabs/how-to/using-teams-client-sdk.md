...
description: Vue d’ensemble Microsoft Teams du SDK client JavaScript, qui peut vous aider à créer Teams expériences d’application hébergées dans un <iframe>. Il inclut des fonctions de base, un espace de noms d’authentification et un espace de noms de paramètres.
