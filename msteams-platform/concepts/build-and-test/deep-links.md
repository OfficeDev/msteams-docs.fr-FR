...
Vous pouvez effectuer un lien profond vers du contenu dans Teams à partir de votre onglet. Cela est utile si votre onglet doit créer un lien vers d’autres contenus dans Teams, tels qu’un canal, un message, un autre onglet ou même pour ouvrir une boîte de dialogue de planification. Pour déclencher un lien profond à partir de votre onglet, vous devez appeler :
...
Par exemple, si vous renvoyez un profil utilisateur Office 365 à partir de votre bot sous forme de carte, ce lien ciblé peut permettre à l’utilisateur de discuter facilement avec cette personne.
...
* `tenantId` : exemple d’ID de locataire, 0d9b645f-597b-41f0-a2a3-ef103fbd91bb
...
* `serviceName` : nom du service, ID d’application. Exemple Teams.
