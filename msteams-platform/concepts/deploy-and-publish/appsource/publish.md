...
## <a name="my-account-verification-status-has-not-advanced-beyond-email-ownership-in-the-partner-center-how-should-i-proceed"></a>L'état de vérification de mon compte n'a pas été avancé au-delà de la propriété de l'e-mail dans l'Centre partenaires. Comment dois-je continuer ?
...
| Gestion de projet | Communication, gestion de projet, flux de travail et gestion de l'entreprise |
