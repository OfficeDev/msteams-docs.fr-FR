...
### <a name="suitable-for-workplace-consumption"></a>Convient à la consommation de l’espace de travail
...
### <a name="feature-names"></a>Noms des fonctionnalités
...
#### <a name="authenticating-with-external-services"></a>Authentification auprès de services externes
...
#### <a name="government-community-cloud-listings"></a>Cloud de la communauté du secteur public listes
...
* Vous pouvez déterminer si un compte est actif indéfiniment ou pendant une durée limitée, mais si le compte expire, aucune interface utilisateur, texte ou liens indiquant la nécessité de payer ne peut s’affiche.
...
## <a name="app-package-and-store-listing"></a>Package d’application et liste du Store
...
### <a name="support-links"></a>Liens de support
...
### <a name="bot-message-spamming"></a>Spammage de messages de bot
...
### <a name="in-meeting-dialogs"></a>Boîtes de dialogue de réunion
