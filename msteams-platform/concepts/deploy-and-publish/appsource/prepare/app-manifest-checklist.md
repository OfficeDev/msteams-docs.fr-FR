...
* Le developerName de votre manifeste doit être identique au nom du fournisseur défini dans l’Partner Center.
...
|Conditions d’utilisation|URL||`developer.termsOfServiceUrl`||Un lien vers vos conditions d’utilisation (HTTPS).|
