...
### <a name="my-account-verification-status-hasnt-advanced-beyond-email-ownership-how-should-i-proceed"></a>L'état de vérification de mon compte n'a pas été avancé au-delà de la propriété de l'e-mail. Comment dois-je continuer ?
...
> * Vous pouvez nous demander de renvoyer l'e-mail en visitant la page de votre profil de partenaire et en sélectionnant le lien renvoyer l'e-mail de **vérification.**
...
Consultez la page [Support pour le programme Commercial Marketplace](/azure/marketplace/partner-center-portal/support) dans l'Espace partenaires pour obtenir des instructions et des étapes pour créer un ticket de support.
