...
|D|**Menu supplémentaire**: inclut des informations et options supplémentaires sur l'application. (Vous pouvez également Paramètres **un** onglet.)|
...
Utilisez l'un des modèles d Teams'interface utilisateur suivants pour vous aider à concevoir votre onglet personnel :
