...
* [Microsoft Azure Active Directory (Azure AD) dans les onglets](~/tabs/how-to/authentication/auth-tab-AAD.md) décrit comment se connecter à Microsoft Azure Active Directory (Azure AD) à partir d’un onglet de l’application dans Teams.
* [L’Microsoft Azure Active Directory d’authentification silencieuse (Azure AD)](~/tabs/how-to/authentication/auth-silent-AAD.md) décrit comment réduire les invites de signature ou de consentement dans l’application à l’aide de Microsoft Azure Active Directory (Azure AD).
