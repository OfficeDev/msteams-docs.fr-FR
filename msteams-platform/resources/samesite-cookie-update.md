...
## <a name="cookies-in-brief"></a>Cookies en bref
 ...
 |**Cookie tiers**|Un cookie tiers est techniquement identique à un cookie de première partie. La différence est que les données sont partagées avec une deuxième partie via un accord de partenariat de données (par exemple, [Microsoft Teams'analyse et de rapports).](/microsoftteams/teams-analytics-and-reports/teams-reporting-reference) |
