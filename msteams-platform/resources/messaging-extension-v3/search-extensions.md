...
Les `onQuerySettingsUrl` `onSettingsUpdate` événements et les  événements fonctionnent ensemble pour activer Paramètres’élément de menu.
...
Pour obtenir une documentation supplémentaire concernant la carte Office 365 connecteur, voir [Utilisation Office 365 cartes de connecteur.](~/task-modules-and-cards/cards/cards-reference.md#office-365-connector-card)
