...
> * Bien qu’il soit possible de créer un [bot Bot Framework](https://dev.botframework.com/bots/new) sans utiliser Azure, vous devez utiliser cette URL (https://dev.botframework.com/bots/new)qui n’est plus exposée dans le portail Bot Framework.
