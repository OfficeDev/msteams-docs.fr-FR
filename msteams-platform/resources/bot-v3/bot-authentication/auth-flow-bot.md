...
4. Lorsque l'utilisateur clique  sur le bouton de signature, Teams ouvre une fenêtre popup et la navigue vers la page de démarrage.
...
Pour obtenir des procédures d'implémentation détaillées pour l'authentification de bot ciblant Azure Active Directory, voir :
