...
> [!NOTE] 
> Vous devez obtenir une licence et prendre en charge les applications créées à partir de modèles d’application pour vos utilisateurs et organisations. Microsoft n’est pas responsable des licences et du support.
...
* **Personnalisables et extensibles :** Bien que tous les modèles d’application peuvent être déployés avec une configuration minimale, nous fournissons l’ensemble des scripts de base de code et de déploiement afin que vous pouvez facilement les personnaliser ou les étendre pour répondre à vos besoins uniques.
