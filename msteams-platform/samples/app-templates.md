...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-celebrations-app)

## <a name="company-communicator"></a>Communicator de l’entreprise
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-company-communicator-app)
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-faqplusplus-app)

![Forum aux questions et GIF](~/assets/images/FAQPlusEndUser.gif)

## <a name="hr-support"></a>Prise en charge des RH
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-hrsupport-app)
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-list-search-app)
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-stickers-app)
...
[Obtenez-le sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-icebreaker-app)
...
[Git sur GitHub ici](https://github.com/OfficeDev/microsoft-teams-app-scrumstatus/)

![Bot d’état de Scrum](https://raw.githubusercontent.com/wiki/OfficeDev/microsoft-teams-app-scrumstatus/images/StartScrum.jpg)

Vous avez une idée pour un modèle d’application que vous aimeriez voir ? N’hésitez pas à nous le signaler [ici](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR2_7qFm_lcZAr4eqEhnLsZ9UMVZGT1lCT0FXUDdZMUM0RkpBS1BESTAwWC4u).
